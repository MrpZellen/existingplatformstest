...
public class Game960Panel extends JPanel implements Runnable{
...
//        testIllegal();
    ...
    public void setPieces() {
        ...
        randNumList.toArray(randNum);
        //add at random positions
        pieces.add(new  Rook(randNum[0],7, WHITE));
        pieces.add(new  Rook(randNum[1], 7,WHITE));
        pieces.add(new  Knight(randNum[2], 7,WHITE));
        pieces.add(new  Knight(randNum[3], 7,WHITE));
        pieces.add(new  Bishop(randNum[4], 7,WHITE));
        pieces.add(new  Bishop(randNum[5], 7,WHITE));
        pieces.add(new  Queen(randNum[6], 7,WHITE));
        pieces.add(new  King(randNum[7], 7,WHITE));
        ...
        //add at random positions
        pieces.add(new  Rook(randNum[0],0, BLACK));
        pieces.add(new  Rook(randNum[1],0, BLACK));
        pieces.add(new  Knight(randNum[2],0, BLACK));
        pieces.add(new  Knight(randNum[3],0, BLACK));
        pieces.add(new  Bishop(randNum[4],0, BLACK));
        pieces.add(new  Bishop(randNum[5],0, BLACK));
        pieces.add(new  Queen(randNum[6],0, BLACK));
        pieces.add(new  King(randNum[7],0, BLACK));
    }
